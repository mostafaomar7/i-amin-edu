...
@Component({
  selector: "new-transactionList",
  templateUrl: "./new-transactionList.component.html",
})
export class NewTransactionListComponent implements OnInit {
  ...
  onFileSelected(event: any): void {
    ...
    this._transactionListListService
  ...
  async getItem(id: string) {
    await this._transactionListListService.getItem(id).then((respone: any) => {
