...
import {AuthenticationService} from './main/pages/authentication/authentication.service';
...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.menu = this.setSideBarMainMenu();
    ...
    ngOnInit(): void {
        ...
        this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
            ...
            // Layout
            //--------
            this._elementRef.nativeElement.setAttribute('dir', this.coreConfig.app.appLanguage === 'en' ? 'ltr' : 'rtl');
    ...
    setSideBarMainMenu() {
        ...
        if (userData && userData?.userType && userData?.userType) {
            return getMenuItems(userData.userType);
        }
    }
}
