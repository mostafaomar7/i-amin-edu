...
import {ImageDisplayModule} from '../../../../@shared/components/image-display.module';
...
@NgModule({
    ...
    imports: [RouterModule, NgbModule, CoreCommonModule, PerfectScrollbarModule, CoreTouchspinModule, ImageDisplayModule],
    providers: [
        {
